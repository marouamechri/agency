...
{
    #[Route('/', name: 'app_appointement_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_appointement_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_appointement_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_appointement_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_appointement_delete', methods: ['POST'])]
